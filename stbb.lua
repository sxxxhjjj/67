...
-- ====================== CONFIG SYSTEM ======================
local ConfigFolder = "DYHUB_V0234_FINAL"
local CustomConfig = {}
...
local translations = {
    Chinese = {
        ...
        override_settings = "覆写设置",
        flush_settings = "冲水设置",
        risky_features = "高风险功能（无检测）",
        esp_visual = "透视视觉",
        esp_settings = "透视设置",
        local_player = "本地玩家",
        redeem_codes = "兑换码",
        unlock_gamepass = "解锁游戏通行证",
        shop_weapon = "商店武器",
        shop_misc = "商店道具",
        batch_section = "无延迟批量购买",
        batch_gacha_section = "无延迟批量抽卡",
        collect_section = "物品收集",
        collect_settings = "收集设置",
        vote_system = "投票系统",
        mode_switch = "模式切换",
        astro_params = "天文币刷取参数",
        auto_game_mode = "自动游戏模式（大厅）",
        extra_auto = "自动化额外",
        visual_section = "视觉效果",
        server_status = "服务器状态",
        others = "其他",
        ...
        motion_prediction_desc = "预判怪物位置（高危）",
        follow_mode = "跟随模式",
        ...
        skill_keys = "自动技能按键",
        weapon_select = "选择武器",
        auto_buy_weapon = "自动购买武器",
        buy_weapon_once = "购买武器（一次）",
        misc_select = "选择道具",
        auto_buy_misc = "自动购买道具",
        buy_misc_once = "购买道具（一次）",
        redeem_selected = "兑换选中码",
        redeem_all = "兑换所有码",
        unlock_selected = "解锁选中通行证",
        restore_vote = "恢复投票系统",
        set_vote_mode = "设置投票模式",
        auto_vote_ig = "自动投票（局内）",
        switch_farm = "▶ 自动挂机模式",
        switch_astro = "✈ 天文币刷取模式",
        astro_duration = "游戏持续时间（秒）",
        astro_radius = "飞行半径",
        astro_speed = "飞行速度",
        select_game_mode = "选择游戏模式",
        auto_game_mode_toggle = "自动游戏模式（大厅）",
        show_cpu_ping = "显示CPU/Ping",
        auto_reconnect = "断线自动重连",
        save_now = "立即保存配置",
        auto_save_config = "自动保存配置",
        save_interval = "保存间隔（秒）",
        reset_override = "重置所有已确认位置",
        padding_reduce = "设置覆写递减步长",
        padding_safe = "设置最小安全高度",
        anti_clip_margin = "防卡墙边距",
        dmg_threshold = "伤害阈值",
        mastery_move_mode = "移动模式",
        mastery_char_type = "角色类型",
        mastery_distance = "与NPC距离",
        batch_items = "批量购买物品",
        batch_amount = "批量购买数量",
        batch_char_spins = "选择抽卡类型（角色）",
        batch_skin_spins = "选择抽卡类型（皮肤）",
        item_notify = "物品通知",
        collect_mode = "收集模式",
        walk_speed = "移动速度",
        jump_power = "跳跃高度",
        fly_speed_label = "飞行速度",
        priority_order = "优先级顺序",
        priority_desc = "GiantST → 直升机 → 高血量精英 → 最近怪物",
        info_update = "更新: 全功能整合",
        info_desc = "- 无后门 | 多语言 | 所有功能已补全",
        info_clean = "纯净版",
        info_clean_desc = "无后门 | 中文界面 | 全功能整合",
    },
    English = {
        ...
        sync_desc = "Aux functions need auto farm",
        ...
        risky_features = "Risky Features (No Detection)",
        esp_visual = "ESP Visual",
        esp_settings = "ESP Settings",
        local_player = "Local Player",
        redeem_codes = "Redeem Codes",
        unlock_gamepass = "Unlock Gamepass",
        shop_weapon = "Shop Weapon",
        shop_misc = "Shop Misc",
        batch_section = "Batch Buy (No Delay)",
        batch_gacha_section = "Batch Gacha (No Delay)",
        collect_section = "Collect Item",
        collect_settings = "Collect Settings",
        vote_system = "Vote System",
        mode_switch = "Mode Switch",
        astro_params = "Astro Coin Farm Parameters",
        auto_game_mode = "Auto Game Mode (Lobby)",
        extra_auto = "Extra Automation",
        visual_section = "Visual Effects",
        ...
        motion_prediction_desc = "Predict NPC position (high risk)",
        follow_mode = "Follow Mode",
        follow_mode_desc = "Stick to NPC every frame",
        ...
        show_ping = "Show Ping",
        fly = "Fly",
        infinity_jump = "Infinity Jump",
        no_clip = "No Clip",
        server_hop = "Server Hop",
        rejoin = "Rejoin",
        save_config = "Save Config",
        anti_afk = "Anti AFK",
        bypass_barrier = "Bypass Barrier",
        fps_boost = "FPS Boost",
        theme = "Theme",
        language = "Language",
        ...
        collect_idgf = "IDGF",
        move_mode = "Move Mode",
        stand_pos = "Farm Position",
        aux_func = "Aux Functions",
        skill_keys = "Auto Skill Keys",
        weapon_select = "Select Weapon",
        auto_buy_weapon = "Auto Buy Weapon",
        buy_weapon_once = "Buy Weapon (Once)",
        misc_select = "Select Misc",
        auto_buy_misc = "Auto Buy Misc",
        buy_misc_once = "Buy Misc (Once)",
        redeem_selected = "Redeem Selected",
        redeem_all = "Redeem All",
        unlock_selected = "Unlock Selected",
        restore_vote = "Restore Vote System",
        set_vote_mode = "Set Vote Mode",
        auto_vote_ig = "Auto Vote (In-Game)",
        switch_farm = "▶ Auto Farm Mode",
        switch_astro = "✈ Astro Coin Farm",
        astro_duration = "Game Duration (s)",
        astro_radius = "Fly Radius",
        astro_speed = "Fly Speed",
        select_game_mode = "Select Game Mode",
        auto_game_mode_toggle = "Auto Game Mode (Lobby)",
        show_cpu_ping = "Show CPU/Ping",
        auto_reconnect = "Auto Reconnect",
        save_now = "Save Config Now",
        auto_save_config = "Auto Save Config",
        save_interval = "Save Interval (s)",
        reset_override = "Reset All Confirmed Positions",
        padding_reduce = "Set Padding Reduce",
        padding_safe = "Set Padding Safe Min",
        anti_clip_margin = "Anti-Clip Margin",
        dmg_threshold = "Damage Threshold",
        mastery_move_mode = "Move Mode",
        mastery_char_type = "Character Type",
        mastery_distance = "Distance to NPC",
        batch_items = "Batch Items",
        batch_amount = "Batch Amount",
        batch_char_spins = "Select Char Spins",
        batch_skin_spins = "Select Skin Spins",
        item_notify = "Item Notify",
        collect_mode = "Collect Mode",
        walk_speed = "Walk Speed",
        jump_power = "Jump Power",
        fly_speed_label = "Fly Speed",
        priority_order = "Priority Order",
        priority_desc = "GiantST → Helicopter → High HP → Nearest",
        info_update = "Update: Full Integration",
        info_desc = "- No backdoor | Multi-language | All features completed",
        info_clean = "Clean Version",
        info_clean_desc = "No backdoor | Chinese UI | Full features",
    },
}Russian = {
    ...
    flush_aura = "Аура слива", flush_range = "Радиус",
...
Portuguese = {
    ...
    god_respawn_threshold = "Limite renascimento",
    ...
    sync_desc = "Вспом. функции требуют ферму",
    sync_on = "Нужна ферма",
    sync_off = "Независимы",
    ...
    esp_health = "Здоровье",
    esp_name = "Имя",
    farm_settings = "Настройки фермы",
    general_settings = "Общие настройки",
    priority_settings = "Настройки приоритета",
    override_settings = "Настройки переопределения",
    flush_settings = "Настройки слива",
    risky_features = "Рискованные функции",
    esp_visual = "ESP визуал",
    esp_settings = "Настройки ESP",
    local_player = "Локальный игрок",
    redeem_codes = "Коды",
    unlock_gamepass = "Разблокировать Gamepass",
    shop_weapon = "Магазин оружия",
    shop_misc = "Магазин прочего",
    batch_section = "Пакетная покупка",
    batch_gacha_section = "Пакетная гача",
    collect_section = "Сбор предметов",
    collect_settings = "Настройки сбора",
    vote_system = "Система голосования",
    mode_switch = "Переключение режима",
    astro_params = "Параметры астро фарма",
    auto_game_mode = "Авто режим игры",
    extra_auto = "Доп. автоматизация",
    visual_section = "Визуальные эффекты",
    server_status = "Статус сервера",
    others = "Прочее",
    save_settings = "Сохранить конфиг",
    ...
    motion_prediction_desc = "Предугадать позицию НПС (опасно)",
    ...
    batch_buy_desc = "Очень быстрая покупка",
    ...
    show_ping = "Показать пинг",
    fly = "Полёт",
    infinity_jump = "Бесконечный прыжок",
    no_clip = "Нет столкновений",
    server_hop = "Смена сервера",
    rejoin = "Перезайти",
    save_config = "Сохранить конфиг",
    anti_afk = "Анти-AFK",
    bypass_barrier = "Обход границ",
    fps_boost = "FPS буст",
    theme = "Тема",
    language = "Язык",
    auto_collect = "Авто сбор",
    collect_clean = "После волны",
    collect_idgf = "Мгновенно",
    move_mode = "Режим движения",
    stand_pos = "Позиция фарма",
    aux_func = "Вспом. функции",
    skill_keys = "Клавиши умений",
    weapon_select = "Выбрать оружие",
    auto_buy_weapon = "Авто покупка оружия",
    buy_weapon_once = "Купить оружие",
    misc_select = "Выбрать предмет",
    auto_buy_misc = "Авто покупка предмета",
    buy_misc_once = "Купить предмет",
    redeem_selected = "Активировать выбранные",
    redeem_all = "Активировать все",
    unlock_selected = "Разблокировать выбранные",
    restore_vote = "Восстановить голосование",
    set_vote_mode = "Выбрать режим голосования",
    auto_vote_ig = "Авто голосование",
    switch_farm = "▶ Режим авто фарма",
    switch_astro = "✈ Режим астро фарма",
    astro_duration = "Длительность игры",
    astro_radius = "Радиус полёта",
    astro_speed = "Скорость полёта",
    select_game_mode = "Выбрать режим игры",
    auto_game_mode_toggle = "Авто режим игры",
    show_cpu_ping = "Показать CPU/Ping",
    auto_reconnect = "Авто переподключение",
    save_now = "Сохранить сейчас",
    auto_save_config = "Авто сохранение",
    save_interval = "Интервал сохранения",
    reset_override = "Сбросить подтверждённые позиции",
    padding_reduce = "Шаг уменьшения отступа",
    padding_safe = "Мин. безопасный отступ",
    anti_clip_margin = "Защита от клиппинга",
    dmg_threshold = "Порог урона",
    mastery_move_mode = "Режим движения",
    mastery_char_type = "Тип персонажа",
    mastery_distance = "Расстояние до NPC",
    batch_items = "Предметы для покупки",
    batch_amount = "Количество",
    batch_char_spins = "Выбрать крутки персонажей",
    batch_skin_spins = "Выбрать крутки скинов",
    item_notify = "Уведомление о предметах",
    collect_mode = "Режим сбора",
    walk_speed = "Скорость ходьбы",
    jump_power = "Сила прыжка",
    fly_speed_label = "Скорость полёта",
    priority_order = "Порядок приоритета",
    priority_desc = "GiantST → Вертолёт → Высокий HP → Ближайший",
    info_update = "Обновление: Полная интеграция",
...
Portuguese = {
    ...
    sync_desc = "Funções auxiliares precisam do auto farm",
    ...
    flush_range = "Alcance da Descarga",
    attack_speed = "Velocidade de Ataque",
    skill_delay = "Atraso de Habilidade",
    height_offset = "Deslocamento de Altura",
    safe_hp = "Limite de HP Seguro",
    god_hp = "Limite de HP Deus",
    high_hp_threshold = "Limite de HP Alto",
    ...
    esp_health = "Vida",
    esp_name = "Nome",
    farm_settings = "Config. Farm",
    general_settings = "Config. Gerais",
    priority_settings = "Config. Prioridade",
    override_settings = "Config. Substituição",
    flush_settings = "Config. Descarga",
    risky_features = "Recursos Arriscados",
    esp_visual = "Visual ESP",
    esp_settings = "Config. ESP",
    local_player = "Jogador Local",
    redeem_codes = "Códigos",
    unlock_gamepass = "Desbloquear Gamepass",
    shop_weapon = "Loja de Armas",
    shop_misc = "Loja Misc",
    batch_section = "Compra em Lote",
    batch_gacha_section = "Gacha em Lote",
    collect_section = "Coletar Item",
    collect_settings = "Config. Coleta",
    vote_system = "Sistema de Voto",
    mode_switch = "Trocar Modo",
    astro_params = "Parâmetros Astro Farm",
    auto_game_mode = "Modo de Jogo Automático",
    extra_auto = "Automação Extra",
    visual_section = "Efeitos Visuais",
    server_status = "Status do Servidor",
    others = "Outros",
    save_settings = "Salvar Config",
    ...
    motion_prediction_desc = "Prever posição do NPC (risco)",
    ...
    fly = "Voar",
    infinity_jump = "Pulo Infinito",
    no_clip = "Sem Colisão",
    server_hop = "Trocar Servidor",
    rejoin = "Reentrar",
    save_config = "Salvar Config",
    anti_afk = "Anti AFK",
    bypass_barrier = "Ignorar Barreira",
    fps_boost = "Otimizar FPS",
    theme = "Tema",
    language = "Idioma",
    auto_collect = "Auto Coleta",
    collect_clean = "Limpo",
    collect_idgf = "IDGF",
    move_mode = "Modo de Movimento",
    stand_pos = "Posição de Farm",
    aux_func = "Funções Auxiliares",
    skill_keys = "Teclas de Habilidade",
    weapon_select = "Selecionar Arma",
    auto_buy_weapon = "Auto Comprar Arma",
    buy_weapon_once = "Comprar Arma",
    misc_select = "Selecionar Misc",
    auto_buy_misc = "Auto Comprar Misc",
    buy_misc_once = "Comprar Misc",
    redeem_selected = "Resgatar Selecionados",
    redeem_all = "Resgatar Todos",
    unlock_selected = "Desbloquear Selecionados",
    restore_vote = "Restaurar Sistema de Voto",
    set_vote_mode = "Definir Modo de Voto",
    auto_vote_ig = "Auto Voto",
    switch_farm = "▶ Modo Auto Farm",
    switch_astro = "✈ Modo Astro Farm",
    astro_duration = "Duração do Jogo",
    astro_radius = "Raio de Voo",
    astro_speed = "Velocidade de Voo",
    select_game_mode = "Selecionar Modo de Jogo",
    auto_game_mode_toggle = "Modo de Jogo Automático",
    show_cpu_ping = "Mostrar CPU/Ping",
    auto_reconnect = "Auto Reconectar",
    save_now = "Salvar Agora",
    auto_save_config = "Auto Salvar Config",
    save_interval = "Intervalo de Salvamento",
    reset_override = "Redefinir Posições Confirmadas",
    padding_reduce = "Definir Redução de Padding",
    padding_safe = "Definir Padding Mínimo",
    anti_clip_margin = "Margem Anti-Clip",
    dmg_threshold = "Limite de Dano",
    mastery_move_mode = "Modo de Movimento",
    mastery_char_type = "Tipo de Personagem",
    mastery_distance = "Distância ao NPC",
    batch_items = "Itens para Lote",
    batch_amount = "Quantidade",
    batch_char_spins = "Selecionar Giros de Personagem",
    batch_skin_spins = "Selecionar Giros de Skin",
    item_notify = "Notificar Item",
    collect_mode = "Modo de Coleta",
    walk_speed = "Velocidade de Caminhada",
    jump_power = "Força do Pulp",
    fly_speed_label = "Velocidade de Voo",
    priority_order = "Ordem de Prioridade",
    priority_desc = "GiantST → Helicóptero → HP Alto → Mais Próximo",
    info_update = "Atualização: Integração Completa",
...
Window:Tag({ Title = "整合版", Color = Color3.fromHex("#db7093") })
...
local WeaponDisplay = {
    "电击枪", "火焰喷射器", "鱼叉枪", "霰弹枪",
    "脉冲步枪", "鱼叉霰弹枪", "EPD", "小型激光枪",
}

local WeaponInternal = {
    ["电击枪"] = "Stungun",
    ["火焰喷射器"] = "Flamethrower",
    ["鱼叉枪"] = "Harpoon Gun",
    ["霰弹枪"] = "Shot Gun",
...
local MiscInternal = {
    ["耳机"] = "HeadPhone",
    ["泰坦呼叫"] = "Titan-Request",
    ["特种泰坦呼叫"] = "SpecialTitan-Request",
    ["扬声器呼叫"] = "Speaker-Request",
    ["手雷"] = "Grenade",
    ["喷气背包"] = "Jetpack",
    ["透镜"] = "Lens",
}
...
local AutoGameValue          = Config:Get("AutoGameValue", "Normal")
...
local Client                 = LocalPlayer-- ====================== ALLY SYSTEM ======================
local AllyNames = {
...
function tp(t)
    pcall(function()
        local c = Client or LocalPlayer.Character
        if c and c:FindFirstChild("Humanoid") and c.Humanoid.Sit == true then
            c.Humanoid.Sit = false
        end
        c:FindFirstChild("HumanoidRootPart").CFrame = t.Target * (t.Mod or CFrame.new(0, 0, 0))
    end)
end
...
function Tp(cf)
    ...
    if not c:FindFirstChild("HumanoidRootPart"):FindFirstChild("BodyClip") then
...
local function GetHelicopter()
    ...
    for _, m in ipairs(living:GetChildren()) do
        if m.Name:lower():find("helicopter") and IsValidMob(m) then
            return m
        end
    end
    return nil
...
local function GetPriorityMob()
    ...
    if g then
        return g, "GiantST", p, 4
    end
    local h = GetHelicopter()
    if h then
        return h, "Helicopter", nil, 3
    end
    local hh = GetHighHPMob()
    if hh then
        return hh, "HighHP", nil, 2
    end
    local n = GetNearestMob()
    if n then
        return n, "NearestMob", nil, 1
    end
...
local function GetMobVisualBounds(mob)
    ...
    for _, part in ipairs(mob:GetDescendants()) do
        if part:IsA("BasePart") and part.Transparency < 0.9 and part.Size.Y > 0.1 then
            ...
            if pos.Y - hy < minY then
                minY = pos.Y - hy
            end
            if pos.Y + hy > maxY then
                maxY = pos.Y + hy
            end
            cx = cx + pos.X
            cz = cz + pos.Z
    ...
    local centerX = cx / cnt
    local centerZ = cz / cnt
    local centerY = (minY + maxY) * 0.5
    return Vector3.new(centerX, centerY, centerZ), minY, maxY
end

local function GetAntiClipFloor(mob)
...
local function ClampPaddingToAntiClip(mob, padding)
    local antiFloor = GetAntiClipFloor(mob)
...
local function StartDamageChecker(mob)
    ...
    task.spawn(function()
        ...
        while mob and mob.Parent and not IsMobDead(mob) and AutoFarmEnabled do
            task.wait(0.3)
            if MobCheckerCancelled[mob] then
                break
            end
            hum = mob:FindFirstChild("Humanoid")
            if not hum then
                break
            end
            local cur = hum.Health
            local last = MobLastHealth[mob] or cur
            local dmg = last - cur
            ...
            if dmg > 0 then
                ...
                if dmg >= DMG_THRESHOLD and MobConfirmedPadding[mob] == nil then
                ...
                if streak >= 2 and MobConfirmedPadding[mob] == nil then
                    if not MobCheckerCancelled[mob] then
                        MobConfirmedPadding[mob] = curPad
                        MobHeightOverride[mob] = curPad
                    end
            ...
            if noDmg >= 3 and not reduced then
                reduced = true
                local curPad = GetEffectivePadding(mob)
...
local function GetTargetCFrame(mob, pos)
    ...
    local targetPos
    if pos == "Above" then
        local y = math.max(maxY + padding, maxY + 0.5)
        targetPos = Vector3.new(center.X, y, center.Z)
    elseif pos == "Under" then
        local y = math.min(minY - padding, minY - 0.5)
        targetPos = Vector3.new(center.X, y, center.Z)
    else
        targetPos = center
    end
    local lookAt = Vector3.new(center.X, pos == "Above" and maxY or minY, center.Z)
    local cf = CFrame.new(targetPos, lookAt)
    if pos == "Above" then
        cf = cf * CFrame.Angles(math.rad(-10), 0, 0)
    elseif pos == "Under" then
        cf = cf * CFrame.Angles(math.rad(10), 0, 0)
    end
    if Rotate90Enabled then
...
local function ScanWorld()
    local now = tick()
    if now - Scanner.LastScan < Scanner.ScanInterval then
        return
    end
...
local function UpdateESPForMob(mob)
    ...
    if settings.name or settings.health or settings.distance then
        ...
        if settings.name then
            table.insert(parts, mob.Name)
        end
        if settings.health then
            local hum = mob:FindFirstChild("Humanoid")
            if hum then
                table.insert(parts, string.format("❤ %.0f/%.0f", hum.Health, hum.MaxHealth))
            end
        end
...
local function UpdateESPForPlayer(playerChar)
    ...
    local settings = GetESPSettings()
    if settings.highlight then
        EnsureHighlight(playerChar, Color3.fromRGB(50, 255, 50))
    end
    if settings.name or settings.health or settings.distance then
        local bill = EnsureBillboard(hrp)
        local label = bill:FindFirstChild("Frame").Label
        local parts = {}
        if settings.name then
            table.insert(parts, Players:GetPlayerFromCharacter(playerChar) and Players:GetPlayerFromCharacter(playerChar).Name or playerChar.Name)
        end
        if settings.health then
...
local function UpdateESPForItem(obj)
    ...
    local settings = GetESPSettings()
    if settings.highlight then
        EnsureHighlight(obj, Color3.fromRGB(255, 215, 0))
    end
...
local function ClearAllESP()
    for mob, _ in pairs(ESP._mobHighlights) do
        pcall(function()
            local hl = mob:FindFirstChild("DYHUB_ESP_HIGHLIGHT")
            if hl then
                hl:Destroy()
            end
        end)
    ...
    for char, _ in pairs(ESP._playerHighlights) do
        pcall(function()
            local hl = char:FindFirstChild("DYHUB_ESP_HIGHLIGHT")
            if hl then
                hl:Destroy()
            end
        end)
            ...
            if mob then
                ...
                if mobType == "GiantST" and extraData then
                    ...
                    giantLockConn = RunService.RenderStepped:Connect(function()
                        if IsMobDead(mob) or not AutoFarmEnabled then
                    ...
                    if SafeModeEnabled and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then
                        local hum = LocalPlayer.Character.Humanoid
                        if (hum.Health / hum.MaxHealth) * 100 < SafeValue then
                            local mobRoot = mob:FindFirstChild("HumanoidRootPart")
                            if mobRoot then
                                tp1(CFrame.new(mobRoot.Position + Vector3.new(0, 111, 0)))
                            end
                            task.wait(0.5)
                        end
                    end
                ...
                WaitingRespawn = true
                local idleCF = IdlePosition
                if FarmMode == "Tween" then
                    local tween = TweenService:Create(HumanoidRootPart, TweenInfo.new(TweenSpeed, Enum.EasingStyle.Linear), { CFrame = idleCF })
                    tween:Play()
                    tween.Completed:Wait()
                else
                    tp1(idleCF)
                ...
                repeat
                    task.wait(0.5)
                until GetPriorityMob() or not AutoFarmEnabled
                WaitingRespawn = false
            end
            task.wait(0.1)
        end
    ...
    task.spawn(function()
        while AutoAttackEnabled and AutoFarmEnabled do
            if not WaitingRespawn then
                pcall(function()
                    ReplicatedStorage.LMB:FireServer()
                end)
            end
            task.wait(0.05)
        end
        ...
        while AutoSkillEnabled and AutoFarmEnabled do
            if not WaitingRespawn then
                ...
                for _, k in ipairs(keys) do
                    if not AutoSkillEnabled or not AutoFarmEnabled then
                        break
                    end
...
local function TriggerAutoSkipHeli(state)
    pcall(function()
        ReplicatedStorage.SetSettingAutoSkipWave:FireServer(state)
    end)
end
-- ====================== DELETE MAP ======================
function SaveAndBoostFPS()
    ...
    for _, e in ipairs(Lighting:GetChildren()) do
        if e:IsA("Atmosphere") or e:IsA("BloomEffect") or e:IsA("ColorCorrectionEffect") or e:IsA("DepthOfFieldEffect") or e:IsA("SunRaysEffect") or e:IsA("Sky") then
            BoostFPS_LightingData["effect_" .. e.Name] = e
            e.Parent = nil
        end
    end
    for _, obj in ipairs(workspace:GetDescendants()) do
...
function RestoreBoostFPS()
    ...
    pcall(function()
        if BoostFPS_LightingData.Brightness then Lighting.Brightness = BoostFPS_LightingData.Brightness end
        if BoostFPS_LightingData.GlobalShadows then Lighting.GlobalShadows = BoostFPS_LightingData.GlobalShadows end
        if BoostFPS_LightingData.FogEnd then Lighting.FogEnd = BoostFPS_LightingData.FogEnd end
        if BoostFPS_LightingData.FogStart then Lighting.FogStart = BoostFPS_LightingData.FogStart end
    end)
    for k, v in pairs(BoostFPS_LightingData) do
        if type(k) == "string" and k:sub(1, 7) == "effect_" and v:IsA("Instance") then
            v.Parent = Lighting
        end
    end
...
function HandleMiscOptions(selectedOptions)
    ...
    local hasAutoAttack = table.find(selectedOptions, T("auto_attack")) ~= nil
    if hasAutoAttack and not AutoAttackEnabled and canRun then
        AutoAttackEnabled = true
        StartAutoAttack()
    elseif not hasAutoAttack and AutoAttackEnabled then
        AutoAttackEnabled = false
    end

    local hasAutoSkill = table.find(selectedOptions, T("auto_skill")) ~= nil
    if hasAutoSkill and not AutoSkillEnabled and canRun then
        AutoSkillEnabled = true
        StartAutoSkill()
    elseif not hasAutoSkill and AutoSkillEnabled then
        AutoSkillEnabled = false
    end

    local hasAutoSkipHeli = table.find(selectedOptions, T("auto_skip_heli")) ~= nil
    ...
    local hasAutoStart = table.find(selectedOptions, T("auto_ready")) ~= nil
    if hasAutoStart and canRun and not AutoStartEnabled then
    ...
    local hasAutoFillUp = table.find(selectedOptions, T("auto_heal")) ~= nil
    if hasAutoFillUp and not AutoFillUpEnabled and canRun then
        AutoFillUpEnabled = true
        StartAutoFillUpLoop()
    elseif not hasAutoFillUp and AutoFillUpEnabled then
    ...
    local hasBoostFPS = table.find(selectedOptions, T("delete_map")) ~= nil
    ...
    while true do
        ...
        if GodModeEnabled then
            pcall(function()
                ...
                if (hum.Health / hum.MaxHealth) * 100 < GodModeValue then
...
local function GetFillUpPart()
    local obj = workspace
    for _, k in ipairs(FILLUP_PART_PATH) do
...
local function IsFillUpPartReady()
    ...
    return p and (p.CFrame.Position - FILLUP_TARGET_POS).Magnitude < 0.5
end
...
local function stepAutoGodMode()
    ...
    if percent <= GodRespawnThreshold then
        ...
        pcall(function()
            LocalPlayer:Kick("Auto God Mode: Respawning")
        end)
    end
end
...
local function getMasteryAttackSpeed()
    if ActionMode == "Slow" then
        return 0.25
    elseif ActionMode == "Faster" then
        return 0.05
    elseif ActionMode == "Flash (Lag)" then
        return 0.01
    else
        return 0.1
    end
...
local function stepMasteryNoFlush()
    ...
    if mob and not WaitingRespawn then
        ...
        if hum and hum.Health > 0 then
            local cf = GetTargetCFrame(mob, FarmPosition)
            if cf then
                if MasteryMovementMode == "Teleport" then
                    tp1(cf)
                else
                    local tween = TweenService:Create(HumanoidRootPart, TweenInfo.new(TweenSpeed, Enum.EasingStyle.Linear), { CFrame = cf })
                    tween:Play()
...
local function stepAstroMode()
    if getgenv().ACTIVE_MODE ~= "astro" then
        if astroOrbitConn then
            astroOrbitConn:Disconnect()
            astroOrbitConn = nil
        end
        if astroStrikeRunning then
    ...
    if astroState == "IDLE" then
        if AstroIsInLobby() then
            AstroVoteAndPrepare()
            astroState = "VOTING"
        end
    elseif astroState == "VOTING" then
        if not AstroIsInLobby() and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            task.wait(2)
            local char = LocalPlayer.Character
    ...
    while true do
        ...
        if mem > 800000 then
            ...
            if mem > 1200000 then
                ...
                for k in pairs(KnownCollectItems) do
                    KnownCollectItems[k] = nil
                end
                for k in pairs(MobHeightOverride) do
                    MobHeightOverride[k] = nil
                end
                for k in pairs(MobConfirmedPadding) do
                    MobConfirmedPadding[k] = nil
                end
...
Scheduler:register("AutoVote", function()
    ...
    Callback = function(state)
        ...
        if state then
            ...
            if SyncFarmOnly then
                TriggerAutoSkipHeli(false)
                WindUI:Notify({ Title = T("auto_farm"), Content = T("farm_disabled") .. " (sync)", Duration = 3, Icon = "square" })
            else
...
Main2:Button({
    ...
    Desc = "一次性兑换所有可用代码",
    Callback = function()
        for _, code in ipairs(redeemCodes or {}) do
            pcall(function()
                ReplicatedStorage:WaitForChild("RedeemCode"):FireServer(code)
                task.wait(0.5)
            end)
...
Main2:Button({
    ...
    Callback = function()
        ...
        local toUnlock = {}
        for _, v in ipairs(SelectedGamepass) do
            if v == "全部" then
        ...
        for _, name in ipairs(toUnlock) do
            pcall(function()
                local bv = gachaData:FindFirstChild(name) or Instance.new("BoolValue", gachaData)
                bv.Name = name
                bv.Value = true
            end)
        end
...
for ch, en in pairs(MiscInternal) do
    miscDisplayMap[en] = ch
end
...
MiscShopDropdown = Main5:Dropdown({
    ...
    Callback = function(ch)
        SelectedMiscItem = MiscInternal[ch]
...
Main7:Slider({
    ...
    Callback = function(v)
        AstroGameDuration = v
        Config:Set("AstroGameDuration", v)
        Config:Save()
    end
})
...
GameModeDropdown = Main7:Dropdown({
    ...
    Multi = false,
    Value = (function()
        for ch, en in pairs(ModeInternal) do
            if en == AutoGameValue then
                return ch
            end
        end
        return "普通模式"
    ...
    Callback = function(ch)
        local en = ModeInternal[ch]
        if en then
            AutoGameValue = en
            Config:Set("AutoGameValue", en)
            Config:Save()
        end
    end
})
    ...
    Callback = function(v)
        ...
        if v then
            game:GetService("NetworkClient").ChildAdded:Connect(function(child)
                if child.Name == "Disconnected" then
                    WindUI:Notify({
                        Title = T("auto_reconnect"),
                        Content = "正在重连...",
                        Duration = 3,
...
if AutoVoteEnabled or AutoStartEnabled then
    task.spawn(function()
        while AutoVoteEnabled or AutoStartEnabled do
            if AutoVoteEnabled then
                FireVote_Solo()
            end
            if AutoStartEnabled then
...
print("[DYHUB] 汉化完整版加载完成！")
print("[DYHUB] 全功能整合 | 无后门 | 多语言界面")
print("[DYHUB] 调度器已启动 | ESP对象复用 | 内存监控")
